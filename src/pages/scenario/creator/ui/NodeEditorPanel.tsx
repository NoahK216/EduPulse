...
const NodeEditorPanel = ({ editorState }: NodeEditorPanelProps) => {
  ...
  return (
    <aside
      className="relative flex h-full shrink-0 border-l border-slate-300 bg-white text-slate-900 shadow-[0_0_30px_rgba(0,0,0,0.08)] dark:border-slate-700/80 dark:bg-slate-900 dark:text-slate-100 dark:shadow-[0_0_30px_rgba(0,0,0,0.35)]"
      style={{
    ...
    >
      ...
      >
        <div className="absolute inset-y-0 left-0 w-px transition bg-slate-300 group-hover:bg-sky-500 dark:bg-slate-600/70 dark:group-hover:bg-sky-300/80" />
      </div>
