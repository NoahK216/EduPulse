      ...
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between gap-4 px-6">
        <div className="flex min-w-0 items-center gap-6">
          <Link to="/" className="shrink-0">
            <img src="/logos/edupulse-with-wordmark.svg" className="h-10 w-auto" alt="EduPulse" />
          </Link>
        ...
        <div className="relative" ref={ref}>
          {typeof showMenu === "undefined" || showMenu ? (
            ...
            >
              ...
              <FiChevronDown className={cn("text-sm", open ? "rotate-180" : undefined)} />
            </button>
          ) : null}
          ...
          {open ? (
            <div className="absolute right-0 mt-3 w-64 overflow-hidden rounded-3xl border border-neutral-200 bg-white/95 p-2 shadow-[0_26px_80px_-36px_rgba(15,23,42,0.45)] backdrop-blur dark:border-neutral-800 dark:bg-neutral-950/96">
              {isPending ? (
                <p className="px-3 py-3 text-sm text-neutral-600 dark:text-neutral-300">Loading...</p>
              ) : isAuthed ? (
                <>
                  <div className="rounded-2xl border border-neutral-200 bg-neutral-50 px-3 py-3 dark:border-neutral-800 dark:bg-neutral-900">
                    <p className="text-xs font-semibold uppercase tracking-[0.16em] text-neutral-500 dark:text-neutral-400">Signed in</p>
                    <p className="mt-2 text-sm font-medium text-neutral-950 dark:text-neutral-50">{userName}</p>
                  </div>
